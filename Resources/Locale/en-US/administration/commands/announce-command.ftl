...
cmd-announce-help = {$command} <message> [sender] [color] [sound] - Send announcement. Sender defaults to HighComm, color to Gold, sound to announce.ogg. The color should be in a #RRGGBB format.

# The default sender for the announcement
cmd-announce-sender = High Command
