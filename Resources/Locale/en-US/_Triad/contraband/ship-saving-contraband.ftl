ship-saving-contraband-examine-verb-text = Ship Storing Eligibility
ship-saving-contraband-examine-verb-message = Check if this item is eligible to be stored on a ship.
