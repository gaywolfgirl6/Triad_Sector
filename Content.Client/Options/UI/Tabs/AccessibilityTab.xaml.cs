...
public sealed partial class AccessibilityTab : Control
{
    public AccessibilityTab()
    {
        ...
        Control.AddOptionCheckBox(TriadCCVars.UseNightVisionColor, UseNightVisionColorCheckBox); // Triad
        Control.AddOptionColorSlider(TriadCCVars.NightVisionColor, NightVisionColorSlider); // Triad
